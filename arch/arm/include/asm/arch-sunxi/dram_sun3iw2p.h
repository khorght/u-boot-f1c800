#ifndef   _SUNXI_DRAM_SUN3IW2_H
#define   _SUNXI_DRAM_SUN3IW2_H

#define DRAM_BASE_ADDR      	0x80000000
#define DRAM_TYPE_ADDR      	0x01c6280c
/*bit17 disable high rank,bit16 disable high DQ*/
#define DRAM_SDL_ADDR       	0x01c62820

#define MCTL_COM_BASE       	SUNXI_DRAM_COM_BASE //0xf1c62000
#define MCTL_CTL_BASE       	SUNXI_DRAM_CTL_BASE //0xf1c63000
 ...
 * ====================================
 */
#define VDD_SYS_PWROFF_GATING        (0xf1c21400 + 0x1f4)
//#define RTC_DATA_110                 (0x01c20400 + 0x110)
//#define RTC_DATA_114                 (0x01c20400 + 0x114)
