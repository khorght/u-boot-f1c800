...
#endif
#ifdef CONFIG_GEN_SUN3IW2P
		/* SDMHx uses Periph0(2x) or Periph1(2x) */
		/* clock_get_pll6() returns default 24M*N*K/2 instead of 24M*N*K -> multiply result by two */
		pll_hz *= 2;
#endif 
	}
...
#ifdef CONFIG_GEN_SUN3IW2P
	/* unassert reset */
	setbits_le32(&ccm->bus_reset0_cfg, 1 << AHB_RESET_OFFSET_MMC(sdc_no));
#else
